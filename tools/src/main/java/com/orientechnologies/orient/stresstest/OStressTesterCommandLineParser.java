...
public class OStressTesterCommandLineParser {
  ...
  private static List<OWorkload> parseWorkloads(final String workloadConfig) {
    if (workloadConfig == null || workloadConfig.isEmpty())
      throw new IllegalArgumentException(
          "Workload parameter is mandatory. Syntax: <workload-name:workload-params>");
  ...
  private static Map<String, String> checkOptions(Map<String, String> options)
      throws IllegalArgumentException {
  ...
  private static Map<String, String> setDefaultIfNotPresent(
  ...
  private static Map<String, String> readOptions(final String[] args)
      throws IllegalArgumentException {
