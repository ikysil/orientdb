...
public abstract class OBaseWorkload implements OWorkload {
  ...
  public class OWorkLoadResult {
    ...
    public String toOutput(final int leftSpaces) {
      ...
      return String.format(
          ...
          indent,
          latencyAvgNs / 1000000f,
          latencyPercentileAvg,
          latencyMinNs / 1000000f,
          latencyPercentile99Ns / 1000000f,
          latencyPercentile999Ns / 1000000f,
  ...
  protected List<OBaseWorkLoadContext> executeOperation(
    ...
    final List<OBaseWorkLoadContext> contexts =
        new ArrayList<OBaseWorkLoadContext>(concurrencyLevel);
              ...
              new Runnable() {
                ...
                public void run() {
                  ...
                  try {
                    ...
                    for (final AtomicInteger i = new AtomicInteger();
                        i.get() < context.totalPerThread;
                        i.incrementAndGet()) {
                              ...
                              try {
                                ...
                                try {
                                  ...
                                  if (operationsPerTransaction > 0
                                          && (i.get() + 1) % operationsPerTransaction == 0
  ...
  protected void manageNeedRetryException(
      final OBaseWorkLoadContext context, final ONeedRetryException e) {}
